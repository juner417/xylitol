...
export nodes="ubuntu@172.19.136.29 ubuntu@172.19.136.31 ubuntu@172.19.136.32 ubuntu@172.19.136.33 ubuntu@172.19.136.34 ubuntu@172.19.136.35 ubuntu@172.19.136.36 ubuntu@172.19.136.37 ubuntu@172.19.136.38 ubuntu@172.19.136.39 ubuntu@172.19.136.40 ubuntu@172.19.136.43 ubuntu@172.19.136.44 ubuntu@172.19.136.45"

# Define all your nodes role: a(master) or i(minion) or ai(both master and minion) or e(extenal etcd), must be the order same 
role=${role:-"a i i i i i i i i i i e e e"}
...
#export SERVICE_CLUSTER_IP_RANGE=${SERVICE_CLUSTER_IP_RANGE:-172.19.139.192/26}  # formerly PORTAL_NET
...
DOCKER_OPTS=${DOCKER_OPTS:-"--insecure-registry 172.19.136.42:5000"}
